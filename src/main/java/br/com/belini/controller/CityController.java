package br.com.belini.controller;
...
import br.com.belini.repository.CityRepository;
...
public class CityController {
	...
	@PutMapping("{id}")
	public String update(@PathVariable("id") Long id, @ModelAttribute("city") City city){
